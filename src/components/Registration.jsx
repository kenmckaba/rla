...
export const Registration = ({
  ...
  return (
    <>
      <Background>
        <Flex w="100%" h="100%" minH="80vh" direction="column">
          <Spacer />
          <Box w="100%" h="100%">
                  ...
                  <ModalBody>
                    <Box justifyContent="center" textAlign="center">
                      <Box paddingBottom="10px">
                        You will soon receive an email with a link you can use to join the training
                      ...
                      <a
                        target="_blank"
                        rel="noreferrer"
                        href={`/registration-update/${attendeeId}`}
                      >
