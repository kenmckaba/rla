...
export const TrainingForm = ({ onClose, trainingId, onDelete }) => {
  ...
  const [meetingId, setMeetingId] = useState('613153446')
  const [moderatorPasscode, setModeratorPasscode] = useState('1694')
  const [participantPasscode, setParticipantPasscode] = useState('7192')
